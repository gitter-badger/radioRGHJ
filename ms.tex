...
%%%
\begin{equation}
n = \frac{\dot M}{4\pi d^2 m_p v}
\end{equation}
%%%
where $\dot M$ is the mass loss rate, $d$ is the orbital distance from the star and $m_p$ is proton mass. 
...
&& \times \left( \frac{\dot M}{\dot M_{\odot}} \right)^{2/3} \left( \frac{v}{v_{\odot}} \right)^{5/3} \left( \frac{d}{5.2~\mbox{AU}} \right)^{-4/3} \label{eq:Pkinp}
\end{eqnarray}
%%%
...
&& \times \left( \frac{\dot M}{10^6 \dot M_{\odot}} \right)^{2/3} \left( \frac{v}{10^{-1} v_{\odot}} \right)^{5/3} \left( \frac{d}{5.2~\mbox{AU}} \right)^{-4/3} \label{eq:Pkinp} \\
&\approx & 2.2 \times 10^4 ~P_{\rm k,\,inp,\,J} \left( \frac{\mathcal{M}}{\mathcal{M}_J} \right)^{2/3} \\
&& \times \left( \frac{\dot M}{10^9 \dot M_{\odot}} \right)^{2/3} \left( \frac{v}{10^{-1} v_{\odot}} \right)^{5/3} \left( \frac{d}{5.2~\mbox{AU}} \right)^{-4/3} \label{eq:Pkinp} \\
&\approx & 490 ~P_{\rm k,\,inp,\,J} \left( \frac{\mathcal{M}}{\mathcal{M}_J} \right)^{2/3} \\
&& \times \left( \frac{\dot M}{\dot M_{\odot}} \right)^{2/3} \left( \frac{v}{v_{\odot}} \right)^{5/3} \left( \frac{d}{0.05~\mbox{AU}} \right)^{-4/3} \label{eq:Pkinp} \\
\end{eqnarray}
%%%
\memoYF{what is the typical wind velocity of AGB stars?}
Therefore, the jupiters to the AGB stars are intrinsically 50 times as bright as typical hot Jupiters. In other words, we could search for radio signal from these stars in $50^3 = 125000$ times as large volume as the canonical hot jupiters.  


Therefore, 
%%%
\begin{eqnarray}
F_{\rm obs} &=& \frac{P_{\rm radio}}{\Omega l^2 f_{\rm cyclotron}} \\
&=& P_{\rm radio,\,J} \\
&\approx & 5\times 10^{-8} \mbox{Jy} \left( \frac{l}{100\mbox{~pc}} \right)^{-2}  \\
&& \times \left( \frac{\dot M}{\dot M_{\odot}} \right)^{2/3} \left( \frac{v}{v_{\odot}} \right)^{5/3} \\
&&\times \left( \frac{\mathcal{M}}{\mathcal{M}_J} \right)^{-1/3} \left( \frac{R_p}{R_{p, J}} \right)^{3} \left( \frac{d}{5.2~\mbox{AU}} \right)^{-4/3} \\
&\approx & 10^{-5} \mbox{Jy} \left( \frac{l}{100\mbox{~pc}} \right)^{-2}  \\
