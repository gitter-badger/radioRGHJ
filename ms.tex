...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Radio Flux from Nearby Evolved Stars}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
(from short to long)
\begin{itemize}
\item Modulation due to planetary spin rotation (condition: misalignment of spin axis and magnetic axis) 
\item modulation due to the presence of satellites??
\item Modulation due to orbital motion of the planet (condition: near edge-on orbit)
\item Variability of stellar wind due to stellar oscillation 
\end{itemize}
