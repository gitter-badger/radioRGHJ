...
&=& r_{s,\,J} \left( \frac{B}{10~\mbox{G}} \right)^{1/3} \left( \frac{\dot a}{5.2\mbox{AU}} \right)^{-1/3}  \\
&& \times \left( \frac{\dot M_\star}{\dot M_\odot} \right)^{-1/6}  \left( \frac{\dot v}{v_{\odot }} \right)^{-1/6} \\
&=& 11.3 \, R_J \left( \frac{B}{10~\mbox{G}} \right)^{1/3}  \left( \frac{\dot a}{5\mbox{AU}} \right)^{-1/3} \\
...
Number of particle which is trapped by planetary magnetosphere is
\begin{equation}
n \propto \pi r_s^2
\end{equation}
