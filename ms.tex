...
It has been known that Jupiter emits radio wave around 20 MHz due to the interaction with plasmas from the satellite Io \memoYF{?}, and 100-3000 MHz, which is cyclotron radiation from electrons that are accelerated in Jupiter's magnetic field \memoYF{?}. 
...
While some indications were obtained \memoYF{?} \citep{lecavelier_et_al2013},  there is no clear detection claimed so far. 
...
When massive stellar wind reach the planetary magnetosphere standoff points  \memoYF{??}, they presumably deposit part of their energy generating bright radio emission. 
...
For the known red giants, the values are typically $\dot M \sim 10^{-8} M_{\odot}$/yr, significantly greater than the solar mass-loss rate $\sim 10^{-14} M_{\odot}$/yr. \memoDS{Can be as high as $10^{-5} M_\odot~{\rm yr^{-1}}$ during AGB phases.  I'm calling it ``red giant'' but we're really thinking of AGB stars for maximum mass-loss and brightness.}
\begin{equation}
