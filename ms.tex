...
Potentially, exoplanets can also generate radio emission through the similar mechanisms, depending on their intrinsic magnetic fields and the density of surrounding plasmas, e.g. stellar wind particles and particles from Io-like moons. 
...
They are also subject to massive (but slow) stellar wind, as the mass-loss rate of such evolved stars are significant, ranging from $\sim  10^{-8} M_\odot$/yr to $\sim  10^{-5} M_\odot$/yr with the highest values for AGB stars \citep[e.g.,][]{reimers1975, schild1989, vassiliadis1993, schoier2001, vanloon2005}, much higher than that of the Sun, $\sim 10^{-14}M_\odot$/yr . 
...
In this paper, we estimate the radio emission from RGHJs and examine the potential to detect planetary them. 
...
Assuming that the stellar wind scales as the escape velocity, i.e., $\propto \sqrt{2GM_{\star}/R_{\star}}$ ($G$ is the gravitational constant, $M_{\star}$ is the stellar mass, and $R_{\star}$ is the stellar radius), a Solar-mass red giant with radius $R_{\star}=100R_{\odot}$ has 10 times as slow stellar wind as that at the Sun, $v_{\odot}$. Thus, 
\begin{equation}
...
\end{equation}
%%%%%%%%%%
\memoYF{dependence on Rossland mean opacity} Therefore, we have
%%%%%%%%%%
\begin{equation}
...
\end{equation}
%%%
On the other hand, the kinetic energy of the moment increases at most
%%%
\begin{equation}
