...
\end{eqnarray}
%%%
If we assume $\alpha = 0.6$ based on constant property wind model, radio flux at 10~pc at 10~MHz-1~GHz is $\sim$ 25 $\mu$Jy-1 mJy, which is below the estimated radio flux of RGHJs. 
