...
In \citet{reiners2010}, the authors adopted new scaling relation of planetary magnetic field based on \citet{christensen2009}.
...
&&\times \left( \frac{\dot M_\star}{10^{-8} M_{\odot }{\rm /yr}} \right) \left( \frac{v}{30\; {\rm km}} \right)^{-1} \left( \frac{a}{5 \; {\rm AU}} \right)^{-2} \label{eq:n_normalized}
\end{eqnarray}
%%%%%%%%%% 
