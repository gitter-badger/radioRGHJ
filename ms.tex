...
An obvious potential obstacle is the intrinsic radio emission from host red giant stars themselves; if they are larger than radio flux from the planets, there is no way to identify the latter.
...
%%%
\begin{eqnarray}
\nonumber f_{\star }(\nu ) &\sim & (0.4-1.4) \times 10^{-3} ~\mbox{Jy} \\
