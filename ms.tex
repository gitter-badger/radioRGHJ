...
%%%
\begin{eqnarray}
r_s &\sim & R_p \left( \frac{B^2}{2\pi m_{\rm p}nv^2}
\right)^{1/6}  \\
&=& 7.57 R_p \left( \frac{B}{10~\mbox{G}} \right)^{1/3} \left( \frac{\dot M_{\star }}{\dot M_{\odot }} \right)^{-1/6}  \left( \frac{\dot v}{v_{\odot }} \right)^{-1/6} 
