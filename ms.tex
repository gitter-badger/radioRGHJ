...
\begin{figure*}[tbp]
   ...
   \caption{A cartoon spectrum of the radio emission of a RGHJ with 10~$M_J$ and the host red giant with 100 $R_{\odot }$. The spectrum of RGHJ is modeled after Jovian radio spectra \citep[e.g.][]{zarka_et_al2004}, while that of the host red giant is obtained simply by extrapolating the radio spectrum observed above 1~GHz to lower ffrequencies assuming a power law. }
  \label{fig:cartoon}
\end{figure*}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
