...
In this paper, we estimate radio emission from RGHJs and examine the potential to detect planetary them. 
...
\end{center}
\label{tab:sens}
\tablecomments{Time estimates to reach 2~$\mu$Jy RMS.  We consider only
