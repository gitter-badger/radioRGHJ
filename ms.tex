...
operate at frequencies $\nu \lesssim 300~\rm MHz$ and can reach continuum 
...
\end{eqnarray}
The confusion limit is dominated by active galactic nuclei, which have low polarization 
fractions $<2.5\%$ \citep{Stil2014} and slowly vary with time \citep{Condon1974,Condon2012}.
...
The LOw-Frequency ARray (LOFAR) operates in the 10-240~MHz range, split in two arrays
using a low band and high band antenna design (LOFAR-LBA and LOFAR-HBA), 
and different pad configuration \cite{vanHaarlem2013}.  
LOFAR's two most sensitive bands are centered at 60~MHz for LOFAR-LBA and 150~MHz 
for LOFAR-HBA respectively.  Given the strong frequency dependence of
...
Heald; \url{http://www.astron.nl/~heald/test/sens.php}} for simplicity, which 
is based on SKA Memo 113\footnote{
 Nijboer, Pandey-Pommier, \& de Bruyn; SKA Memo 113; 
...
Instrument & Band & Sensitivity & Time  & Resolution & Confusion limit\\
 & MHz & $\mu$Jy~hr$^{1/2}$ &  hr & \arcsec\ & $\mu$Jy bm$^{-1}$ \\[0.25pc] 
\hline\\[-0.5pc]
%ASKAP & 700-1700~MHz & 37 & 342.3 \\ % table 3 of http://www.atnf.csiro.au/projects/askap/config.html
GMRT  & 235~MHz &  165.6 & 6860 & 13 \\ % http://gmrt.ncra.tifr.res.in/~astrosupp/obs_setup/sensitivity.html
HERA  & 70~MHz  &  &  \\ % http://reionization.org/wp-content/uploads/2015/05/HERA0_imaging.pdf
% https://www.astron.nl/~heald/test/sens.php; 
% 24 core stations, 16 remote, 8 international, 488 subbands
LOFAR &  30-80  & 700 &  & 8.3 & 120 \\
LOFAR & 110-200 &  35 &  & 3.3 & 2.6\\  
LWA   &  30-80  &  &  \\
SKA   & 200  &  &  \\
UTR-2 & & & \\
