...
{\bf and some order:} \\
%
Jason Nordhaus\altaffilmark{?} [Add correct affiliation] \\
%
Nikku Madhusudhan\altaffilmark{3} \\
%
Mehrdad Mirbabayi\altaffilmark{1} \\
%
Aaron Parsons\altaffilmark{4} \\
%
Tony Mroczkowski\altaffilmark{5} \\
%
Neil Zimmerman\altaffilmark{6}
}

\affil{$^1$Astrophysics Department, Institute for Advanced Study,
  Princeton, NJ 08540}

\affil{$^2$Astronomy Department, RIT}
